...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-md-3">
                      ...
                      <select class="form-control select2" id="kind_id" name="kind_id" style="width: 100%;">
                        ...
                        if ($q1->num_rows($q1) > 0) {
                          echo '<option value="">-Select-</option>';
                          foreach ($q1->result() as $res1) {
                            echo "<option value='" . $res1->id . "'>" . $res1->kind_name . "</option>";
                          }
                        } else {
                          ?>
                          <option value="">No Records Found</option>
  ...
  <script type="text/javascript">
    ...
    function load_datatable() {
      ...
      var selectedOption = $('#category_id').find(':selected');
      ...
      var table = $('#example2').DataTable({
        ...
        "ajax": {
          ...
          "data": {
            ...
            category_item_id: $("#category_item_id").val(),
            kind_id: $("#kind_id").val(),
          },
    ...
    $("#brand_id,#category_id,#kind_id").on("change", function () {
