...
<body class="hold-transition skin-blue  sidebar-mini">
 ...
 -->
                                 ...
                                 <label for="item_image"><?= $this->lang->line('select_image'); ?></label>
                                 <input type="file" name="item_image" id="item_image">
                                 <span id="item_image_msg" style="display:block;" class="text-danger">Max Width/Height: 300px * 200px & Size: 300kB, nếu ảnh không hiển thị hãy thử ảnh logo 75*50 </span>
                        ...
                        <div class="row">
                           <div class="form-group col-md-4">
                              ...
                              <input type="text" class="form-control only_currency" id="price" name="price" placeholder="Giá gốc mua chưa có thuế" value="<?php print $price; ?>">
                        ...
                        <div class="row">
                           <div class="form-group col-md-4 <?= tax_disable_class() ?>">
                              <label for="tax_type"><?= $this->lang->line('tax_type'); ?><span class="text-danger">*(cái này ko rõ, để mặc định đi)</span></label>
                        ...
                        <div class="row">
                           <div class="form-group col-md-4">
                              ...
                              <input type="text" class="form-control only_currency " id="final_price" name="final_price" placeholder="Giá bán cuối cùng" value="<?php print $final_price; ?>" readonly>
                        ...
                        <div class="row">
                           <div class="form-group col-md-4">
                              ...
                              <select class="form-control" id="discount_type" name="discount_type" style="width: 100%;">
                                 ...
                                 <option value='Fixed'>Giảm cố định(<?= $CI->currency() ?>)</option>
                              </select>
